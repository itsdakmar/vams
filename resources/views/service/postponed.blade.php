...
@section('main-content')
    <div class="breadcrumb">
        ...
        <ul>
            <li><a href="">Senarai Servis Jentera Tangguh</a></li>
        </ul>
    </div>
                            ...
                            <div class="tab-pane fade show active" id="list-home"
                                ...
                                <div class=" text-left ">
                                    <div class="table-responsive">
                                        <table id="services-postponed-table"
...
@section('page-js')
    <script>
        $(document).ready(function () {
            let oTable = $('#services-postponed-table').DataTable({
                processing: true,
                serverSide: true,
                order: [[0, "desc"]],
                ajax: {
                    url: '{{ route('data.service.postponed') }}'
                },
                columns: [
                    {
                        data: 'tarikh',
            ...
            $('#selVehicle').appendTo('#services-postponed-table_wrapper > .row > .col-sm-12:first');
