...
@section('main-content')
    <div class="breadcrumb">
        ...
        <ul>
            <li><a href="">Kemaskini Maklumat Penyelenggaraan</a></li>
        </ul>
    </div>
                    ...
                    <form action="{{ route('service.update', $data->id) }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                <div id="balai">
                                    ...
                                    <select id="selVehicle" name="no_kenderaan" class="form-control @error('no_kenderaan') is-invalid @enderror">
                                        <option value="{{ $data->vehicle->no_kenderaan }}">{{ $data->vehicle->no_kenderaan }}</option>
                                    </select>
                                    @error('no_kenderaan')
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('kos') is-invalid @enderror" value="{{ $data->kos }}" name="kos" id="kos"
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <label class="checkbox checkbox-outline-primary">
                                    <input name="service[servis]" value="1" {{ (old('service.servis', $data->servis) == 1) ? 'checked' : '' }} type="checkbox" class="@error('service') is-invalid @enderror" >
                                    <span>Servis</span>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="checkbox checkbox-outline-primary">
                                    <input name="service[enjin]" value="1" {{ (old('service.enjin', $data->enjin) == 1) ? 'checked' : '' }} type="checkbox" >
                                    <span>Enjin</span>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="checkbox checkbox-outline-primary">
